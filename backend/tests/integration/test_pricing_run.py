"""Integration smoke test for pricing runs."""
...
@pytest.mark.asyncio
async def test_pricing_answers_drive_full_pipeline_and_persist_artifacts(
    client: httpx.AsyncClient,
) -> None:
    create = await client.post(
        ...
        json={
            "task_type": "pricing",
            "goal": "Validate pricing strategy",
            "document_ids": [],
        },
    )
    ...
    try:
        ...
        submit = await client.post(
            ...
            json={"answers": {"pricing_scope": "Enterprise SaaS"}},
        )
