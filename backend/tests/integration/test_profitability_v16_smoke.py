"""V1.6 smoke test for the profitability profile."""
...
@pytest.mark.asyncio
async def test_profitability_v16_profile_runs_with_workers_and_stage_tools(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    spec = ProfileSmokeSpec(
        task_type="profitability",
        goal="Diagnose SaaS profitability",
        answer_key="profit_pool",
        ...
        tool_agents=(
            "stage1_revenue.revenue_decomposition",
            "stage2_cost.cost_structure",
            "stage4_competitor.peer_benchmarks",
        ),
        final_report_heading="Profitability Final Report",
    )
